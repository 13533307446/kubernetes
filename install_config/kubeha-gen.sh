...
kubectl apply -f https://github.com/13533307446/kubernetes/raw/master/install_config/rbac.yaml
curl -fsSL https://github.com/13533307446/kubernetes/raw/master/install_config/calico.yaml | sed "s!8.8.8.8!${CP0_IP}!g" | sed "s!10.244.0.0/16!${CIDR}!g" | kubectl apply -f -
...
organizationName_value          = kumanju
...
emailAddress_value              = 13533307446@163.com
...
kubectl apply -f https://github.com/13533307446/kubernetes/raw/master/install_config/traefik.yaml
kubectl apply -f https://github.com/13533307446/kubernetes/raw/master/install_config/metrics.yaml
kubectl apply -f https://github.com/13533307446/kubernetes/raw/master/install_config/kubernetes-dashboard.yaml
